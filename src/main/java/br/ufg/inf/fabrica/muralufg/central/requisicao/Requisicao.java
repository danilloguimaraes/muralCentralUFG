...
public class Requisicao {
    ...
    /**
     * Define a mensagem da requisição.
     * Se a mensagem for nula, uma IllegalArgumentException é lançada.
     * 
     * @param mensagem  A mensagem da requisição.
     */
    public void setMensagem(Mensagem mensagem) {
        if (mensagem == null) {
            throw new IllegalArgumentException("Mensagem da requisição é nula.");
        } else {
            this.mensagem = mensagem;
        }   
    }
    ...
    /**
     * Define a lista de destinatários alvos da requisição.
     * Se a lista estiver vazia, uma IllegalArgumentException é lançada.
     * 
     * @param listaDestinatarios    A lista de destinatários da requisição.
     */
